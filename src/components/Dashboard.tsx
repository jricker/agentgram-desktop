              ...
              <>
                ...
                <div className="p-6">
                  <Card className="overflow-hidden">
                    <div className="grid grid-cols-[1fr_100px_100px_120px_80px_60px] gap-3 px-5 py-3 border-b border-border text-xs font-medium text-muted-foreground uppercase tracking-wide">
                      <span>Agent</span>
                      <span>Backend</span>
                      <span>Model</span>
                      <span>Status</span>
